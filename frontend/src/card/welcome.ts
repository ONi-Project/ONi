 ...
 <div class="card-welcome__card-content">
    ...
    <div class="card-welcome__text-container">
      ...
      <div style="margin-top: auto; width: fit-content;">
        <mdui-chip elevated style="margin-right: 0.5rem;" href="https://github.com/ltfjx/Oni" target="_blank">GitHub 仓库</mdui-chip>
        <mdui-chip elevated href="https://github.com/ltfjx/Oni" target="_blank">使用教程</mdui-chip>
      </div>
    </div>
  </div>
</mdui-card>

...
export type OcToServer = ocToServer.AuthRequest | ocToServer.DataCommonSet | ocToServer.DataAeItemList | ocToServer.DataAeCpuList | ocToServer.AeOrderResult | ocToServer.DataEventAdd | ocToServer.DataEventSet | ocToServer.DataBotComponent | ocToServer.Log;
export type General = general.Info | general.Warning | general.Error;
export type All = ServerToWeb | WebToServer | ServerToOc | OcToServer | General;
